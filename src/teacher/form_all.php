                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50" id="re06" role="tabpanel" aria-labelledby="re06-tab">
                                ...
                                <table class="min-w-full table-auto border-collapse rounded-[12px]">
                                    ...
                                    <tbody>
                                        <?php
                                        try {
                                            $stmt2 = $pdo->prepare("SELECT 'RE06' as form_type, form_id as form_id, term, year, f.course_id, `Group`, status, reason, coutter, 	reg_status, teacher_email, token,
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50" id="re07" role="tabpanel" aria-labelledby="re07-tab">
                                ...
                                <table class="min-w-full table-auto border-collapse rounded-[12px]">
                                    ...
                                    <tbody>
                                        ...
                                        // การดึงข้อมูลจากฐานข้อมูล
                                        try {
                                            $stmt3 = $pdo->prepare("SELECT 'RE07' as form_type, form_id as form_id, term, year, f.course_id, `group`, status, reason, gpa, git_unit, reg_status, expected_graduation, comment_teacher, comment_head_dep, token, email,
