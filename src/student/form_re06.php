    ...
    <div class="flex flex-col sm:flex-row h-screen">
        ...
        <div id="sidebar" class="sm:w-1/4 md:w-1/5 bg-white shadow-lg p-4 m-6 flex flex-col justify-between rounded-[20px]">
            <div class="text-center">
                ...
                <button class="w-full bg-white text-[#EF6526] hover:bg-[#EF6526] hover:text-white text-left py-2 px-4 rounded-[12px] shadow-md" id="dashboard-btn"> Dashboard </button>
                <div class="mt-4 space-y-2">
                    <button class="w-full bg-[#EF6526] text-white py-2 rounded-[12px] mt-4 shadow-md" id="re6">คำร้องขอเพิ่มที่นั่ง RE.06</button>
